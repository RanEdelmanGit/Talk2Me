...
const Sidebar = ({
  ...
  return (
    <div className="w-full md:w-72 bg-gray-200 px-4 md:py-4 shadow-md md:max-h-svh  max-md:fixed max-md:top-16 rounded-md md:pr-6 z-10 ">
      ...
      >
        ...
        <div className="flex justify-end pb-3 max-md:hidden ">
          <button onClick={onToggleFavorites} className="flex items-center">
